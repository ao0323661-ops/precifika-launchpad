      ...
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6 max-w-lg mx-auto">
          <div className="h-20 w-20 rounded-full bg-amber-50 flex items-center justify-center">
            {isExpired ? <RefreshCw className="h-10 w-10 text-amber-600" /> : <Lock className="h-10 w-10 text-amber-600" />}
          </div>
          ...
          <div className="flex flex-col gap-3 w-full">
            <Button onClick={() => window.location.href = '/dashboard/pricing'} size="lg" className="w-full text-lg font-bold py-6">
              Ver Planos e Preços
            </Button>
