    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-base font-semibold text-primary tracking-wide uppercase">Planos e Preços</h2>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {PLANS.map((plan) => (
            ...
            >
              ...
              <div className="mb-8">
                <div className={`h-12 w-12 rounded-xl bg-${plan.color === 'primary' ? 'primary' : plan.color + '-100'} flex items-center justify-center mb-4`}>
                  <plan.icon className={`h-6 w-6 text-${plan.color === 'primary' ? 'white' : plan.color + '-600'}`} />
                </div>
